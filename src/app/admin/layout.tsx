...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* backdrop-blur only blurs what's behind this element, never its own
          children — so no linework/pattern div lives inside the header.
          Adding one here would paint crisp lines on top and make the blur
          look broken no matter how strong it is. */}
      <header className="sticky top-0 z-50 border-b border-primary/25 bg-primary/15 backdrop-blur-2xl">
